...
Introduction.prototype.loadLandAreaChart = function(){
    ...
    var option = {
        ...
        xAxis: [{
            type: 'category',
            data: ['工作票', '操作票', '抢修', '用电调查', '设备巡视', '现场勘查', '到岗到位','工作票', '操作票', '抢修', '用电调查', '设备巡视', '现场勘查', ],
        ...
        series: [{
            type: 'bar',
            data: [300, 450, 770, 203, 255, 188, 156,450, 770, 203, 255, 188, 156],
            barWidth: '15px',
            itemStyle: {
                normal: {
...
Introduction.prototype.loadPopulationChart = function(){
    ...
    var option = {
        ...
        "series": [{
                ...
                "data": [13,42,67,81,86,94,166,220,249,262,42,67,81,86,94,166,522],
            },
